...
uint256 hashGenesisBlock("0xb92b6f876337da2b0153485f511637d8acd7edc0cc84019e6aade96df11410e1");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcaf1e4736ed12db444034f29b9b42f496ae94815e23caf371f48c45cad07b868");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nTime    = 1439655607;
        block.nNonce   = 2087307903;

        if (fTestNet)
        {
            block.nTime    = 1439655607;
            block.nNonce   = 387518825;
        }
